...
| Credential theft or brute force | Argon2id PIN verifier, five-failure/15-minute local throttle, 15-minute Rust-owned device sessions, secure key store | Local staff enrollment/rotation/revocation and PIN/session foundation verified; passkeys and managed recovery pending |
